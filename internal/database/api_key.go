...
func (s *service) CreateAPIKey(key APIKey) error {
	_, err := s.db.ExecContext(context.Background(),
		`INSERT INTO api_key
		 (id, key_hash, key_prefix, is_active, created_at, expires_at, rate_limit, usage_count)
		 VALUES ($1,$2,$3,$4,$5,$6,$7,$8)`,
		key.ID, key.KeyHash, key.KeyPrefix, key.IsActive, key.CreatedAt, key.ExpiresAt, key.RateLimit, key.UsageCount)
	return err
}
